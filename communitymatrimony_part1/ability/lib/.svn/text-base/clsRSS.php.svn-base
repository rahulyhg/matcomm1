...
class rss {
	...
	var $itemLink;
	var $itemDescription;
	//var $itemadditional_information;
	var $itemAuthor;
	var $itemCategory;
	var $itemComments;
	var $itemEnclosure;
	...
	function startRSS($path = '.', $filename = 'test'){
    	$this->path = $path;
        ...
        //$this->rss .= $this->s(2) . '<additional_information>' . $this->additional_information . '</additional_information>' . "\n";
	...
	//function itemadditional_information($additional_information){ $this->itemadditional_information = $additional_information; }
