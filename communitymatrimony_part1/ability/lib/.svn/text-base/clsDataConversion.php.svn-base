...
if($varServerRoot == ''){
	$varServerRoot = '/home/product/community/ability/www';
}
...
class DataConversion extends DB
{
	...
	function generateMatriId($argCommunityId, $argPrefix)
	{
		...
		$funQuery	= 'INSERT INTO '.$varDbInfo['DATABASE'].'.'.$varTable['MATRIIDINFO']."(CommunityId,MatriId) VALUES('".$argCommunityId."','')";
