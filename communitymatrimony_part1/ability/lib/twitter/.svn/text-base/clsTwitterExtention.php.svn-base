...
$docRoot = ($docRoot == "")?"/home/product/community/ability":$docRoot;
...
class TwitterExtention extends DB {
	...
	public function setTwitterAccountId($argMatriId, $argTwitterId, $argPortalId) {
		...
		else if($userRs['status'] == 400 || $userRs['status'] == 420 || $userRs['status'] == 500 || $userRs['status'] == 502 || $userRs['status'] == 503) {
