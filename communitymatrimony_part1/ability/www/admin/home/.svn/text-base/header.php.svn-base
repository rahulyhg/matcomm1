...
<div style="padding-top: 2px;" >
	...
	?>
		<div class="fleft" style="width: 380px;" id="logo"><img src="<?=$confValues['IMGSURL']?>/logo/<?=$varGetFolderLogo;?>_logo.gif" alt="Community Matrimony" border="0" height="40" width="380"></div>
		<div class="fright">
