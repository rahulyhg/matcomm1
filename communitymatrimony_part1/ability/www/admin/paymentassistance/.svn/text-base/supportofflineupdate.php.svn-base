...
if($_REQUEST['offernum']!='' && ($_REQUEST['discountVal']!='' || $_REQUEST['nextLevelOffer']!='' || $_REQUEST['xtra']!='' || $_REQUEST['discountAmount'] != '')) {
//if($_REQUEST['PaymentCategorynew']!='' && ($_REQUEST['disPre']!='' || $_REQUEST['nextOffer']!='' || $_REQUEST['assured']!='' || $_REQUEST['ExtraPhNo']!='')) {
//include_once("/home/office/cc/www/bmconfig/ccconf.inc");
#post values from query1.php
	echo "<br>exp date - ".$expiryDatetrm = trim($_REQUEST['FDATEEXP']);
...
$offerStartDate = date("Y-m-d")." 00:00:00";
...
//	$argFieldsValue = array("'".$matriId."'","'".$offercategory."'","'0'","'0000-00-00  00:00:00'","'".$offercode."'","'now()'","'".$telecallerexpdate."'","'6'","'".$exPhoneNo."'","'".$DiscountPercentage."'","''","''","''","''","''","'".$asugift."'","''","'".$nextoffer."'","'now()'","'0'");
		...
		$argFieldsValue = array("'".$matriId."'","'".$offercategory."'","'0'","'0000-00-00  00:00:00'","'".$offercode."'","'".$offerStartDate."'","'".$telecallerexpdate."'","'6'","'".$exPhoneNo."'","'".$menmberdis."'","''","''","''","''","''","'".$asugift."'","''","'".$nextoffer."'","now()","'0'");
