...
function offerDetails($matriId)
{
	...
	$varCondition = " WHERE MatriId = '$matriId' order by DateUpdated desc limit 1";
...
function easyPay($matriId)
{
	...
	$eprCond = " where matriId = '$matriId' order by RequestDate desc limit 1";
...
function tmFollowupDetails($matriId)
{
	...
	$varCondition = " where MatriId = '$matriId' order by DateCalled desc limit 1";
