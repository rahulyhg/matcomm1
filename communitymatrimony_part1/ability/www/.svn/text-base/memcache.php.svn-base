...
$MEMCACHE_SERVERS[] = '192.168.1.19:11210'; // add more as an array
//$MEMCACHE_SERVERS[] = '192.168.1.16:1234'; // add more as an array
//$MEMCACHE_SERVERS[] = '192.168.1.11:1234'; // add more as an array
...
function flushServer($server){
    ...
    $resetResp = sendMemcacheCommand($host,$port,'stats reset');
    return $resp .' '. $resetResp;
}
