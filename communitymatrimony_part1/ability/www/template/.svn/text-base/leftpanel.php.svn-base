...
<div class="lpanel fright" style="padding-top:35px;">
	...
	<div class="lpanelinner1 brdr smalltxt clr padt10">
		<center>
		<div class="lpanelinner1b tlleft"><font class="normtxt bld">Experience the joys of finding an <?=$varUcDomain?> Partner</font><br/><br/>
		...
		<ul class="lh16" style="margin-top:4px;margin-bottom:10px;margin-left:10px !important;margin-left:16px; padding-left:5px !important;padding-left:0px;"><li>Actively search among 1000s of profiles</li>
		<li>Post your photos free</li>
		<li>Verify your phone number</li>
		<li>Access members info</li>
		<li>View members photos & horoscope</li>
		<li>Contact members absolutely free</li>
		<li>Send personalised messages </li>
		<li>Call members on phone</li>
