...
if ($varLogoName=='') { $varLogoName	= 'ability'; }
...
$varPaidStatusInfo = "member since $varMemberSince <br />"; // <a href=\"".$confValues['SERVERURL']."/payment/\" class=\"clr1\">".chkPremimumMembership()." to enjoy more benefits >></a>";
...
<!-- <div class="fleft normtxt clr" style="width:450px; padding:10px 0px 0px 0px;line-height:17px;">
