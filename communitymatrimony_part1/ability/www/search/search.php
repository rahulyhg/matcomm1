...
<form style="margin: 0px; padding: 0px;" name="RSearchForm" action="<?=$varResultsURL;?>" method="post">
	<div class="rpanel fleft">
		...
		<div class="smalltxt clr2 padt5 padl"><font class="clr bld">Basic</font> &nbsp;|&nbsp; <a href="index.php?act=advsearch" class="clr1">Advanced</a> &nbsp;|&nbsp; <a href="index.php?act=memidsearch" class="clr1">By Member ID</a></div><br clear="all">
