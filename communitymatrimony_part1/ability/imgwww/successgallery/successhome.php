...
echo "ss:".$varRootBasePath		= $_SERVER['DOCUMENT_ROOT'];
...
echo "<br>".$varCntFile				= $varRootBasePath."/success/stories/count.txt";
...
$varImage					= $confValues['SERVERURL']."/success/smallphotos/".trim($varId)."i.jpg";
