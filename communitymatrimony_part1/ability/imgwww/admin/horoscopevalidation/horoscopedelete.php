...
if($_POST['frmDeleteHoroscopeSubmit'] == 'yes' && $varMatriId != '')
{
	...
	echo '<link rel="stylesheet"	href="'.$confValues['CSSPATH'].'/global-style.css"><div><div style="padding: 0px 20px 0px 20px;"><div style="padding:5px;" class="mediumtxt boldtxt clr3">Delete Photo</div> <div style="padding:10px;" class="divborder">'.$varMessage.'<br clear="all"><div class="fright" style="padding:5px 4px 3px 3px;" id="closebt"><input type="button" value="Close" class="button" onclick="parent.document.getElementById(\'divphotodelete\').style.display=\'none\';parent.window.location.href=\'adminmanagehoroscope.php\';" id="closebutton"></div></div></div>';exit;
