...
if ($varSubmit == 'yes')
{
	...
	if ($varPrimary=="User_Name")
	{
		...
		$argCondition			= "WHERE User_Name=".$objMailManager->doEscapeString($varUsername,$objMailManager);
	...
	$argCondition				= "WHERE
	MatriId=".$objMailManager->doEscapeString($varMatriId,$objMailManager);
	...
	if ($varRecordsNumber=='1')
	{
		...
		$argCondition			= "MatriId=".$objMailManager->doEscapeString($varMatriId,$objMailManager);;
