...
if($adminUserName != 'nazir' && $adminUserName != 'vijay.anand' && $adminUserName != 'prathi' && $adminUserName != 'admin') {
  echo "You are not a authorised user to access this page";exit();
}
$arrUserType=array('nazir'=>array(2=>'Admin executive'),'admin'=>array(2=>'Admin executive'),'vijay.anand'=>array(3=>'Admin view access'),'prathi'=>array(3=>'Admin view access'));
...
<table border="0" cellpadding="0" cellspacing="0" align="left" WIDTH="542">
		...
		<tr>
			...
			<td class="smalltxt"><input type="text" name="User_Name" id="User_Name" size="15" class="normaltxt1 required checkSpace" minlength="3" maxlength="15" value="<?php echo $_POST['User_Name'];?>">&nbsp;</td>
		</tr>
