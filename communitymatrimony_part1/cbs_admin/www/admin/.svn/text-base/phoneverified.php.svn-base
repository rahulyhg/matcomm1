...
if ($varMatriId != "" && $_POST['frmPhoneVerifySubmit']=='yes') {
	...
	$varUpCondition		= " MatriId=".$objDB->doEscapeString($varMatriId,$objDB);
	$varFields			= array('Contact_Phone','Contact_Mobile','Phone_Verified');
	$varFieldsValues	= array($objDB->doEscapeString($varPhoneNumber,$objDB),$objDB->doEscapeString($varMobileNumber,$objDB),$objDB->doEscapeString($varPhoneVerify,$objDB));
	...
	if ($varPhoneVerify==1) {
		...
		$varCondition			= " WHERE MatriId=".$objDB->doEscapeString($varMatriId,$objDB);
		...
		if($varCheckProfileCnt > 0) {
			...
			$varFieldsValues= array($objDB->doEscapeString($varCountryCode,$objDB),$objDB->doEscapeString($varAreaCode,$objDB),$objDB->doEscapeString($varPhoneNo,$objDB),$objDB->doEscapeString($varMobileNo,$objDB),$objDB->doEscapeString($varPhoneNumber1,$objDB),$varPhoneVerify,"'".$varCurrentDate."'",1,2);
			...
			$varFieldsValues= array($objDB->doEscapeString($varMatriId,$objDB),"'".$varCurrentDate."'",$objDB->doEscapeString($varCountryCode,$objDB),$objDB->doEscapeString($varAreaCode,$objDB),$objDB->doEscapeString($varPhoneNo,$objDB),$objDB->doEscapeString($varMobileNo,$objDB),$objDB->doEscapeString($varPhoneNumber1,$objDB),$varPhoneVerify,"'".$varCurrentDate."'",1,2);
		...
		if($varMatriIdPrefix=='ABL') {
			...
			$argFieldsValues	= array($objDB->doEscapeString($varMatriId,$objDB),$objDB->doEscapeString($varPhoneNumber1,$objDB),"'".$varCurrentDate."'");
		...
		if($varCheckProfileCnt > 0) {
			$varFields		= array('CountryCode','AreaCode','PhoneNo','MobileNo','PhoneNo1','PhoneStatus1','DateConfirmed','VerifiedFlag','VerificationSource');
			$varFieldsValues= array($objDB->doEscapeString($varCountryCode,$objDB),$objDB->doEscapeString($varAreaCode,$objDB),$objDB->doEscapeString($varPhoneNo,$objDB),$objDB->doEscapeString($varMobileNo,$objDB),$objDB->doEscapeString($varPhoneNumber1,$objDB),$varPhoneVerify,"''",0,0);
			...
			$varFieldsValues= array($objDB->doEscapeString($varPinNo,$objDB),$objDB->doEscapeString($varMatriId,$objDB),"'".$varCurrentDate."'",$objDB->doEscapeString($varCountryCode,$objDB),$objDB->doEscapeString($varAreaCode,$objDB),$objDB->doEscapeString($varPhoneNo,$objDB),$objDB->doEscapeString($varMobileNo,$objDB),$objDB->doEscapeString($varPhoneNumber1,$objDB),$varPhoneVerify,"''",0,0);
