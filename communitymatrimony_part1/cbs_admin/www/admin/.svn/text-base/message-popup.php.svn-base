...
?>
	<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<table border="0" cellpadding="4" cellspacing="0" class="brownpopclr" width="500" bgcolor="#FFFFFF" height="200">
			...
			<tr><td align="center" valign="bottom"><a href="javascript:window.close();" class="formlink1"><input type="button" class="button" onclick="window.close()" value="Close Window"></a>&nbsp;</td></tr>
		</table>
	</body>
</html>
