...
if ($_REQUEST['frmCheckValidityPeriodSubmit'] == 'yes') {
	...
	$varFieldsValue	= array($objMasterDB->doEscapeString($varNewValidityPeriod,$objMasterDB),"'".$varCurrentDate."'",'DATE_ADD(\''.$varCurrentDate.'\', INTERVAL '.$varNewValidityPeriod.' DAY)','1');
