...
<div id="maincontainer">
	<div id="container">
		...
		$arrLeftMenuList	= array('3'=>array('view-profile1'=>"Yes",'profile'=>"Yes",'pmail'=>"Yes",'view-profile'=>"Yes",'deleted-profile'=>"Yes",'paymenthistory'=>"Yes",'view-profile-email'=>"Yes",'login'=>"Yes",'logout'=>"Yes",'manage-users'=>"Yes"),'4'=>array('view-profile1'=>"Yes",'profile'=>"Yes",'pmail'=>"Yes",'view-profile'=>"Yes",'deleted-profile'=>"Yes",'paymenthistory'=>"Yes",'view-profile-email'=>"Yes",'login'=>"Yes",'logout'=>"Yes",'manage-users'=>"Yes"));
