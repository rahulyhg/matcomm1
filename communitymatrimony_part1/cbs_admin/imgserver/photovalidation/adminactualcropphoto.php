...
<head>
	...
	function alertContents_crop() {
        if (http_request.readyState == 4) {
            if (http_request.status == 200) 
			{
				...
				window.location.href = IMAGE_URL+'/admin1/photovalidation/adminphotobrightness.php?id='+matriid+'&divno=<?=$varDivNum;?>&num='+photo_no+'&rand='+Math.random();
			} else {
 ...
 <div id="main_div" style="width:700px;padding-left:60px;padding-top:5px;padding-bottom:10px;">
	...
	<input id="closebutton" type="button" value="Save & Close" class="button pntr" onclick="parent.window.close();">
	</div>  
	<div>
		<br clear="all">
