...
<div style="float:left; width:492px;border:1px solid #D3D3D3;" class="smalltxt">	
	...
	<div style="text-align:left;" class="smalltxt">
		...
		<div class="fright"><input type="button" class="button" name="addphotos"  value="Add More Photos"onClick="javascript:window.location='<?=$confValues['IMAGEURL'];?>/admin1/photovalidation/adminmanagephoto.php?MATRIID=<?=$_GET['ID'];?>';">
</div><br clear="all">
</div>