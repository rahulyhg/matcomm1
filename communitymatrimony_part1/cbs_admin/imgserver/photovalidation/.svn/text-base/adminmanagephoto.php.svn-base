					...
					<div class="tl">
						<div class="tr">
							...
							<div style="text-align:center;">
								...
								<!-- inside content -->
	<form method="post" name="addphoto" action="<?=$confValues['IMAGEURL'];?>/admin1/photovalidation/adminphotoadd.php" enctype="multipart/form-data" onSubmit="return validateFile();" style="padding:0px;margin:0px;"> 
		<div class="smalltxt">
