...
include_once($varRootBasePath.'/www/admin1/includes/config.php');
...
if($_COOKIE['adminLoginInfo']==''){
    ...
    header("location:$urllogin/admin1/index.php?act=login");
}
...
<tr><td><hr></td></tr><tr><td align="right"><a 
onclick="parent.window.location.href='http://support.communitymatrimony.com/admin/index.php?act=admin-profile-valid&pps=no&ps=yes'" class="mediumtxt clr1 boldtxt" align='right'>Home</a>
&nbsp;<a href='<?=$confValues['IMGURL'];?>/admin1/successstory/index.php' class="mediumtxt clr1 boldtxt" align='right'>Admin Home</a>
</td></tr>
</td></tr></table>
<br clear="all">
