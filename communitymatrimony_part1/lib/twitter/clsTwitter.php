...
class Twitter {
	...
	public function __construct() {
		...
		$this->headers = array('Expect:', 'X-Twitter-Client: ','X-Twitter-Client-Version: ','X-Twitter-Client-URL: ', 'Authorization: OAuth oauth_consumer_key=\"'. CONSUMER_KEY .'\", oauth_token=\"'. OAUTH_TOKEN .'\", oauth_version=\"'. OAUTH_VERSION .'\"');
