...
Class MailerBasicView extends DB
{
	...
	function mailMatchWatchBasicDetails($argPurpose,$varBasicDetails,$argLink='',$argMailerName='', $argTrackDtls='', $argMsgId='')
	{
		...
		if($argPurpose=='match' || $argPurpose=='photo') {
			...
			$funInboxLink		= '<a href="'.$this->funServerUrl.'/login/index.php?'.$varTrackDetail.'redirect='.$this->funServerUrl.'/profiledetail/index.php?act=fullprofilenew~id='.$funMatriId.'~msgfl=1~msgty=R~msgid='.$argMsgId.'" style="text-decoration:none; color:'.$varLinkClr.';">Reply</a>&nbsp;&nbsp;&nbsp;<a href="'.$this->funServerUrl.'/login/index.php?'.$varTrackDetail.'redirect='.$this->funServerUrl.'/profiledetail/index.php?act=fullprofilenew~id='.$funMatriId.'~msgfl=1~msgty=R~msgid='.$argMsgId.'" style="text-decoration:none; color:'.$varLinkClr.';">Decline</a>';
		} else if($argPurpose=='inbox_ei') {
			$varBasicView		= $this->funMailerTplPath."/inboxbasic.tpl"; //do change (template file)
			$funInboxLink		= '<a href="'.$this->funServerUrl.'/login/index.php?'.$varTrackDetail.'redirect='.$this->funServerUrl.'/profiledetail/index.php?act=fullprofilenew~id='.$funMatriId.'~msgfl=2~msgty=R~msgid='.$argMsgId.'" style="text-decoration:none; color:'.$varLinkClr.';">Accept</a>&nbsp;&nbsp;&nbsp;<a href="'.$this->funServerUrl.'/login/index.php?'.$varTrackDetail.'redirect='.$this->funServerUrl.'/profiledetail/index.php?act=fullprofilenew~id='.$funMatriId.'~msgfl=2~msgty=R~msgid='.$argMsgId.'" style="text-decoration:none; color:'.$varLinkClr.';">Decline</a>';
		}
