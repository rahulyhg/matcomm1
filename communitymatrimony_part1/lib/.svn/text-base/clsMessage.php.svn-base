...
# Filename		: clsMessage.php
# Module		: Message
#================================================================================================================
# Description   : checking Abusive words,removing unneeded script tags from message.
#================================================================================================================
...
Class Message extends BasicView
{
	...
	function abusivewordsOccurance($argMessage)
	{
		...
		while (list($key,$valu) = each($arrCompetitorList)) {
			if(preg_match("/\b$valu\b/i", $argMessage)) {
				$funSpamFlag[0]=1; $words .= $valu." ";
			}
		}
